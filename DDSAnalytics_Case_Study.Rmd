...
# - Install plyr and load it
# - Install corrplot and load it
...
#Total Working Years
ggplot(empDF) + geom_histogram(aes(TotalWorkingYears),binwidth=5, fill="green", col="black")

#Number of Companies Worked
ggplot(empDF) + geom_histogram(aes(NumCompaniesWorked),binwidth=2, fill="green", col="black")

#Distance From Home
ggplot(empDF) + geom_histogram(aes(DistanceFromHome),binwidth=5, fill="green", col="black")
```
...
```{r uni_non_cat_demo_financial}
#Look at total employee financial demographics such as DailyRate, HourlyRate, MonthlyRate

#HourlyRate
ggplot(empDF) + geom_histogram(aes(HourlyRate), binwidth = 5, fill="blue", col="black")

#DailyRate
ggplot(empDF) + geom_histogram(aes(DailyRate), binwidth = 100, fill="blue", col="black")

#MonthlyRate
ggplot(empDF) + geom_histogram(aes(MonthlyRate), binwidth = 1000, fill="blue", col="black")
```
...
#Monthly Income
ggplot(empDF) + geom_histogram(aes(MonthlyIncome), binwidth = 1000, fill = "orange",col = "black")

#Percent Salary Hike
ggplot(empDF) + geom_histogram(aes(PercentSalaryHike), binwidth = 1, fill = "orange",col = "black")

#Years At Company
ggplot(empDF) + geom_histogram(aes(YearsAtCompany), binwidth = 2, fill = "orange",col = "black")

#Years in Current Role
ggplot(empDF) + geom_histogram(aes(YearsInCurrentRole), binwidth = 2, fill = "orange",col = "black")

#Years Since Last Promotion
ggplot(empDF) + geom_histogram(aes(YearsSinceLastPromotion), binwidth = 2, fill = "orange",col = "black")

#Years with Current Manager
ggplot(empDF) + geom_histogram(aes(YearsWithCurrManager), binwidth = 2, fill = "orange",col = "black")
```
...
###Observations
* There are no patterns in this data.
